...
(function() {
  Commerce.Page = DS.Model.extend({
    title: DS.attr('string'),
    sub: DS.attr('string'),
    body: DS.attr('string'),
    topicId: DS.belongsTo('Commerce.TopicId'),
    userId: DS.attr('belongs'),
...
(function() {
  Commerce.Topic = DS.Model.extend({
    name: DS.attr('string')
  });

}).call(this);
(function() {
  Commerce.PageView = Ember.View.extend({
    templateName: 'page'
  });

}).call(this);
(function() {
  Commerce.PagesView = Ember.View.extend({
    templateName: 'pages'
  });

}).call(this);
(function() {
  Commerce.TopicView = Ember.View.extend({
    templateName: 'topic'
  });

}).call(this);
(function() {
  Commerce.TopicsView = Ember.View.extend({
    templateName: 'topics'
  });
