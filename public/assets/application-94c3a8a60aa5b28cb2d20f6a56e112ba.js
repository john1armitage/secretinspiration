...
(function() {
  jQuery(function() {
    ...
    $(document).on("click", 'input#cash_payment', function(event) {
      ...
      if (total !== null && total > 0) {
        if (total >= due) {
          ...
          return $('input#order_tip').val(total - due);
        } else {
          $('input#order_paid').val(total);
          return $('input#order_tip').val(0);
        }
      }
    });
    $(document).on("click", 'input#card_payment', function(event) {
      var credit_card, due, total;
    ...
    return $(document).on("click", 'input.variant', function(event) {
      var variant;
...
(function() {
  Commerce.PayRateView = Ember.View.extend({
    templateName: 'pay_rate'
  });

}).call(this);
(function() {
  Commerce.PayRatesView = Ember.View.extend({
    templateName: 'pay_rates'
  });
