...
(function() {
  Commerce.Daily = DS.Model.extend({
    accountDate: DS.attr('date,'),
    turnover: DS.attr('decimal,'),
    tips: DS.attr('number'),
    headcount: DS.attr('number'),
    session: DS.attr('string')
  });

}).call(this);
(function() {
  Commerce.Timesheet = DS.Model.extend({
    employee: DS.attr('belongs'),
    hours: DS.attr('number')
  });

}).call(this);
(function() {
  Commerce.DailiesView = Ember.View.extend({
    templateName: 'dailies'
  });

}).call(this);
(function() {
  Commerce.DailyView = Ember.View.extend({
    templateName: 'daily'
  });

}).call(this);
(function() {
  Commerce.TimesheetView = Ember.View.extend({
    templateName: 'timesheet'
  });

}).call(this);
(function() {
  Commerce.TimesheetsView = Ember.View.extend({
    templateName: 'timesheets'
  });
